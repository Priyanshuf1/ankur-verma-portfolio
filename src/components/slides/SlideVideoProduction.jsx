  ...
  return (
    <div className="w-full h-full flex flex-col justify-between items-center px-4 py-3 max-w-6xl mx-auto overflow-hidden">
      ...
      <div className="text-center shrink-0 mt-1 mb-2">
        <div className="inline-flex items-center gap-2 bg-red-950/90 border border-red-600 px-4 py-1.5 rounded-full mb-1 shadow-lg">
          <Film className="w-4 h-4 text-red-500" />
          <span className="font-futuristic text-xs sm:text-sm text-white uppercase tracking-widest font-black">
      ...
      <div className="relative my-auto w-full max-w-4xl h-[360px] sm:h-[420px] md:h-[460px] rounded-3xl overflow-hidden bg-black/90 border-2 border-red-600 shadow-[0_0_50px_rgba(239,68,68,0.6)] group flex items-center justify-center">
        {/* Video Element */}
        <video
          ref={videoRef}
        ...
        {!isPlaying && (
          <button
            onClick={togglePlay}
            className="absolute z-30 w-20 h-20 rounded-full bg-red-600/95 border-2 border-white text-white flex items-center justify-center shadow-2xl hover:scale-110 transition-transform cursor-pointer"
            title="Play Video"
          >
        ...
        {/* Video Control Bar */}
        <div className="absolute bottom-0 left-0 right-0 z-30 bg-gradient-to-t from-black/95 via-black/80 to-transparent p-4 flex flex-col gap-2 opacity-95 group-hover:opacity-100 transition-opacity">
          {/* Progress Bar */}
          ...
          <div className="flex items-center justify-between text-white">
            <div className="flex items-center gap-3">
              ...
              <span className="font-futuristic text-xs sm:text-sm text-white font-bold hidden sm:inline uppercase tracking-widest">
